...
public class Order extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	findViewById(R.id.bottom_order_layout_ly).setSelected(true);
        ...
        if (pul.spid.equals("") || pul.susername.equals(""))
        {
        	...
        	.setPositiveButton("确定", new DialogInterface.OnClickListener() {   
    			public void onClick(DialogInterface dialog, int whichButton) {   
    				Intent i = new Intent(Order.this, Myxf.class);    
    	        	Order.this.startActivity(i);
    	        	Order.this.finish();
    				}   
    				})
        	.show();
        }
        pul.addActivity(Order.this);
        ...
        if (pul.sact.equals(""))
        {
        content_wv.loadUrl(getResources().getString(R.string.weburl)+"index.php?c=main&a=getorder&username="+pul.susername+"&pid="+pul.spid);
        }

        if (pul.sact.equals("help"))
        {
        content_wv.loadUrl("file:///android_asset/help.html");
        pul.sact="";
        }
        if (pul.sact.equals("book"))
        {
        content_wv.loadUrl("file:///android_asset/book.html");
        pul.sact="";
        }
        if (pul.sact.equals("alltime"))
        {
        content_wv.loadUrl(getResources().getString(R.string.weburl).replace("call20/", "")+"open/pay.php?act=all&username="+pul.susername+"&pid="+pul.spid);
        pul.sact="";
        }
      } 
    ...
    public void mcall1(View bottom_home_bn_style){
    	Intent i = new Intent(Order.this, Call.class); 
    	Order.this.startActivity(i);
    }
    public void mcall2(View bottom_card_bn_style){
    	Intent i = new Intent(Order.this, Txl.class); 
    	Order.this.startActivity(i);
    }
    public void mcall3(View bottom_msg_bn_style){
    	Intent i = new Intent(Order.this, Msg.class); 
    	Order.this.startActivity(i);
    }
    ...
    public void mcall5(View home_bottom_other_bn){
    	Intent i = new Intent(Order.this, Other.class); 
    	Order.this.startActivity(i);;
    }
